...
window.onload=()=>{
    ...
    for (const key in library) {
        ...
        let nombre=JSON.stringify(library[key].title);
        ...
        let propiedad=JSON.stringify(library[key].cover);
    ...
    //    console.log(ima);
        articulo.addEventListener("click",()=>{
            let objetString=JSON.stringify(library[key]);
...
/*
    ...
    articulos.forEach(function (params, key) {
